 ...
 insertRecord = () =>{
  this.setState({
    isLoading: true
      ...
      fetch('http://localhost/reactnative/InsertStudentData.php', {
      method: 'POST',
      headers: {
  ...
  if (this.state.isLoading) {
   ...
   return (
    ...
    class ShowStudentListActivity extends Component {
      ...
      componentDidMount() {
          return fetch('http://localhost/reactnative/ShowAllStudentsList.php')
            .then((response) => response.json())
            .then((responseJson) => {
...
class EditStudentRecordActivity extends Component {
  ...
  constructor(props) {
    ...
    updateRecord = () =>{
      this.setState({
        isLoading: true
            ...
            fetch('http://localhost/reactnative/UpdateStudentRecord.php', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
    ...
    deleteRecord = () =>{
          fetch('http://localhost/reactnative/DeleteStudentRecord.php', {
          method: 'POST',
          headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
